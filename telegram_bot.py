...
if __name__ == '__main__':
    if bot:
        print("🚀 Telegram Bot with Hermes AI Agent is LIVE and polling for documents...", flush=True)
        while True:
            try:
                bot.remove_webhook()
                time.sleep(2)
                ...
                print(f"⚠️ Telegram Polling notice: {ex}. Re-acquiring polling lock in 5s...", flush=True)
                time.sleep(5)
    else:
